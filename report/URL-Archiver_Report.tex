...
\setupSignature{
	...
	A. Vejseli={\includegraphics[width=.5\linewidth]{sig_example}},
	K. Wampfler={\includegraphics[width=.5\linewidth]{sig_example}}
}
...
\input{content/system_delimitation}
...
%\input{content/scrum}
%\input{content/scrum_review}

\chapter{Deployment/Integration}
\input{content/licensing_and_compliance}
\input{content/installation}
\input{content/user_manual}

\chapter{Conclusion}
\input{content/discussion}
\input{content/bottom_line}
...
\include{content/libraries_and_licenses}
\section{Class Diagram}\label{app:class_diagram}
\textattachfile[color=black]{diagrams/uml_diagram.pdf}{Class Diagram PDF (Double click to download)}
