...
Currently, the system uses a command-line interface. The MVC-Pattern \index{MVC-Pattern} lays the groundwork for potential future implementation of a GUI interface.
