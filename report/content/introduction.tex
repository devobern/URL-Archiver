...
The product goal \index{product goal} is a platform independent Java application called "URL-Archiver".
...
\section{Priorities}
The following priorities\index{priorities} are listed in order of importance:
\begin{enumerate}
